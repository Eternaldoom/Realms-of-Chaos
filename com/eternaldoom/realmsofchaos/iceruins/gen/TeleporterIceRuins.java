...
public class TeleporterIceRuins extends Teleporter
{
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        {
            TeleporterIceRuins.PortalPosition portalposition = (TeleporterIceRuins.PortalPosition)this.destinationCoordinateCache.getValueByKey(j1);
            d3 = 0.0D;
            ...
            for (l3 = l - short1; l3 <= l + short1; ++l3)
            {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
                {
                    ...
                    for (int i2 = this.worldServerInstance.getActualHeight() - 1; i2 >= 0; --i2)
                    {
                        ...
                        {
                            while (this.worldServerInstance.getBlock(l3, i2 - 1, l1) == ROCBlocks.ice_portal)
                            {
                                --i2;
                            }
        ...
        if (d3 >= 0.0D)
        {
            if (flag)
            {
                this.destinationCoordinateCache.add(j1, new TeleporterIceRuins.PortalPosition(i, j, k, this.worldServerInstance.getTotalWorldTime()));
    ...
    public boolean makePortal(Entity par1Entity)
    {
        ...
        if(this.worldServerInstance.getBlock(i, j, k) != Blocks.air){
        	int yCoord = 0;
        	while(yCoord<256){
        		if(this.worldServerInstance.getBlock(i, yCoord-4, k) == Blocks.air){
        			j = yCoord;
        		}
        	}
        }
    ...
    public void removeStalePortalLocations(long par1)
    {
        if (par1 % 100L == 0L)
        {
            ...
            while (iterator.hasNext())
            {
                ...
                TeleporterIceRuins.PortalPosition portalposition = (TeleporterIceRuins.PortalPosition)this.destinationCoordinateCache.getValueByKey(olong.longValue());
