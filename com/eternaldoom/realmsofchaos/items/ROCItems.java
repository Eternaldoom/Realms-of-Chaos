...
public class ROCItems {
	...
	public static void init(){
		...
		citronite_helmet = new ItemROCArmor(CITRONITEa, HELMET, "citronite", "helmetCitronite", 56D);
		citronite_chestplate = new ItemROCArmor(CITRONITEa, CHESTPLATE, "citronite", "chestplateCitronite", 56D);
		citronite_leggings = new ItemROCArmor(CITRONITEa, LEGGINGS, "citronite", "leggingsCitronite", 56D);
		citronite_boots = new ItemROCArmor(CITRONITEa, BOOTS, "citronite", "bootsCitronite", 56D);
		
		xylite_helmet = new ItemROCArmor(XYLITEa, HELMET, "xylite", "helmetXylite", 60D);
		xylite_chestplate = new ItemROCArmor(XYLITEa, CHESTPLATE, "xylite", "chestplateXylite", 60D);
		xylite_leggings = new ItemROCArmor(XYLITEa, LEGGINGS, "xylite", "leggingsXylite", 60D);
		xylite_boots = new ItemROCArmor(XYLITEa, BOOTS, "xylite", "bootsXylite", 60D);
		...
		iron_helmet = new ItemROCArmor(IRONa, HELMET, "iron", "helmetIron", 44D).register("iron_helmet");
		iron_chestplate = new ItemROCArmor(IRONa, CHESTPLATE, "iron", "chestplateIron", 44D).register("iron_chestplate");
		iron_leggings = new ItemROCArmor(IRONa, LEGGINGS, "iron", "leggingsIron", 44D).register("iron_leggings");
		iron_boots = new ItemROCArmor(IRONa, BOOTS, "iron", "bootsIron", 44D).register("iron_boots");
		diamond_helmet = new ItemROCArmor(DIAMONDa, HELMET, "diamond", "helmetDiamond", 52D).register("diamond_helmet");
		diamond_chestplate = new ItemROCArmor(DIAMONDa, CHESTPLATE, "diamond", "chestplateDiamond", 52D).register("diamond_chestplate");
		diamond_leggings = new ItemROCArmor(DIAMONDa, LEGGINGS, "diamond", "leggingsDiamond", 52D).register("diamond_leggings");
		diamond_boots = new ItemROCArmor(DIAMONDa, BOOTS, "diamond", "bootsDiamond", 52D).register("diamond_boots");
	...
	{
        return ArmorMaterial.IRON;//EnumHelper.addEnum(ArmorMaterial.class, name, durability/14, new int[]{0, 0, 0, 0}, enchantability);
    }
