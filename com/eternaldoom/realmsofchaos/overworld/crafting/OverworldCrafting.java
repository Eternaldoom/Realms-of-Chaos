...
public class OverworldCrafting {
	...
	public static void initRecipes(){
		...
		GameRegistry.addRecipe(new ItemStack(ROCOverworldItems.flame_stone), new Object[]{"ACA", "XLX", "ACA", 'A', ROCOverworldItems.ash_dust, 'C', ROCOverworldItems.citronite_stone, 'X', ROCOverworldItems.xylite_ingot, 'L', Items.lava_bucket});
		...
		RecipeHelper.addArmorRecipe(ROCOverworldItems.flame_helmet, ROCOverworldItems.flame_chestplate, ROCOverworldItems.flame_leggings, ROCOverworldItems.heliotrope_boots, ROCOverworldItems.flame_stone);
		...
		RecipeHelper.addToolRecipe(ROCOverworldItems.flame_sword, ROCOverworldItems.flame_pickaxe, ROCOverworldItems.flame_axe, ROCOverworldItems.flame_shovel, ROCOverworldItems.flame_stone);
