...
public class BlockFrozenChest extends BlockContainer
{
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            if (tileentity instanceof TileEntityFrozenChest)
            {
                ((TileEntityFrozenChest)tileentity).setCustomName(stack.getDisplayName());
            }
        }
    }
    ...
    public ILockableContainer getLockableContainer(World worldIn, BlockPos p_180676_2_)
    {
        ...
        {
            Object object = (TileEntityFrozenChest)tileentity;
            ...
            else
            {
                ...
                while (iterator.hasNext())
                {
                    ...
                    if (block == this)
                    {
                        ...
                        if (tileentity1 instanceof TileEntityFrozenChest)
                        {
                            if (enumfacing != EnumFacing.WEST && enumfacing != EnumFacing.NORTH)
                            {
                                object = new InventoryLargeChest("container.chestDouble", (ILockableContainer)object, (TileEntityFrozenChest)tileentity1);
                            }
                            else
                            {
                                object = new InventoryLargeChest("container.chestDouble", (TileEntityFrozenChest)tileentity1, (ILockableContainer)object);
                            }
                        }
                    }
                }
