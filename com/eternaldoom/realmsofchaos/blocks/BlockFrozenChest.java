...
public class BlockFrozenChest extends BlockContainer{
	
	protected BlockFrozenChest() {
		super(Material.ice);
		setCreativeTab(ROCTabs.Blocks);
		setBlockTextureName("ice");
		setHardness(12.0f);
		setResistance(10.0f);
		setBlockName("chestFrozen");
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		return new TileEntityFrozenChest();
	}
    ...
    {
        Object object = (TileEntityFrozenChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_);
        ...
        else
        {
            ...
            {
                object = new InventoryLargeChest("container.chestDouble", (TileEntityFrozenChest)p_149951_1_.getTileEntity(p_149951_2_ - 1, p_149951_3_, p_149951_4_), (IInventory)object);
            }

            if (p_149951_1_.getBlock(p_149951_2_ + 1, p_149951_3_, p_149951_4_) == this)
            {
                object = new InventoryLargeChest("container.chestDouble", (IInventory)object, (TileEntityFrozenChest)p_149951_1_.getTileEntity(p_149951_2_ + 1, p_149951_3_, p_149951_4_));
            }

            if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ - 1) == this)
            {
                object = new InventoryLargeChest("container.chestDouble", (TileEntityFrozenChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ - 1), (IInventory)object);
            }

            if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ + 1) == this)
            {
                object = new InventoryLargeChest("container.chestDouble", (IInventory)object, (TileEntityFrozenChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ + 1));
            }
	...
	public void breakBlock(World world, int i, int j, int k, Block block, int par6) {
		TileEntityFrozenChest items = (TileEntityFrozenChest)world.getTileEntity(i, j, k);
		if(items != null) {
	...
	private IInventory getInventory(World world, int i, int j, int k) {
		Object obj = (TileEntityFrozenChest)world.getTileEntity(i, j, k);
