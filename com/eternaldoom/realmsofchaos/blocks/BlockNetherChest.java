...
public class BlockNetherChest extends BlockContainer
{
    ...
    public IBlockState checkForSurroundingChests(World worldIn, BlockPos pos, IBlockState p_176455_3_)
    {
        if (worldIn.isRemote)
        {
            return p_176455_3_;
        ...
        {
            IBlockState iblockstate1 = worldIn.getBlockState(pos.offsetNorth());
            IBlockState iblockstate2 = worldIn.getBlockState(pos.offsetSouth());
            IBlockState iblockstate3 = worldIn.getBlockState(pos.offsetWest());
            IBlockState iblockstate4 = worldIn.getBlockState(pos.offsetEast());
            ...
            if (block != this && block1 != this)
            {
                ...
                {
                    BlockPos blockpos2 = block2 == this ? pos.offsetWest() : pos.offsetEast();
            ...
            {
                BlockPos blockpos1 = block == this ? pos.offsetNorth() : pos.offsetSouth();
            ...
            worldIn.setBlockState(pos, p_176455_3_, 3);
            return p_176455_3_;
        }
    }
